...
public class FriendsFragment extends Fragment {
    ...
    public void onStart(){
        super.onStart();
         ...
         FirebaseRecyclerAdapter<Friends, FriendsViewHolder> friendsRecyclerViewAdapter = new FirebaseRecyclerAdapter<Friends,
                FriendsViewHolder>(
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        friendsViewHolder.mView.setOnClickListener(new View.OnClickListener(){
                            ...
                            public void onClick(View view){
                                ...
                                CharSequence options[] = new CharSequence[]{"Open Profile", "Send Message","Locations"};
